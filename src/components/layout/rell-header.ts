...
export class RellHeader extends BaseComponent {
  ...
  protected getComponentStyles(): string {
    ...
    return `
      ...
      .header {
        ...
        box-shadow: ${shadow};
        border-bottom: ${variant === 'transparent' ? 'none' : '1px solid var(--rell-border-default)'};
...
customElements.define('rell-header', RellHeader);
